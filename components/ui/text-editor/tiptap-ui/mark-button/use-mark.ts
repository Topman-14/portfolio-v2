...
// --- Icons ---
import { BoldIcon } from "@/components/ui/text-editor/tiptap-icons/bold-icon"
import { Code2Icon } from "@/components/ui/text-editor/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/components/ui/text-editor/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/components/ui/text-editor/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/components/ui/text-editor/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/components/ui/text-editor/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/components/ui/text-editor/tiptap-icons/underline-icon"
